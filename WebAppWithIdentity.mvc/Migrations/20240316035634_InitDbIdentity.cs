        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdIdentityUser = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUsers_AspNetUsers_IdIdentityUser",
                        column: x => x.IdIdentityUser,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUsers_IdIdentityUser",
                table: "AppUsers",
